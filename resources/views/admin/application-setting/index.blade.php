                ...
                <div class="card-body">
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div id="mail-setting" class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="meta-jobapplicationlimitation">@lang('modules.jobs.jobapplicationlimitation')</label>
                                    <input type="number" id="meta-title" class="form-control" name="job_application_limitation" value="{{$setting->job_application_limitation ?? "0"}}">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="col-md-12">
                            <h4 class="card-title mb-4 text-primary">@lang('modules.applicationSetting.googlemapapiSetting')</h4>
                        </div>
                        <div class="col-md-12">
                        <div class="form-group">
                            <label for="meta-entergogglemapapikey">@lang('modules.jobs.gogglemapapikey')</label>
                            <input type="text" id="meta-title" class="form-control" name="google_map_api_key" value="{{$setting->google_map_api_key ?? ""}}">
                        </div>
                        </div>
                        <hr>
