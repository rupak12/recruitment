 ...
 @if($global->job_alert_status == 1)
    @if( isset($alertId) && !is_null($alertId))
        <div class="topbar-left ">
               ...
               <button class="btn btn-danger disable-job-alert" type="button">@lang('modules.front.disableJobAlert')</button>
               </div>
    @else
        <div class="topbar-left d-none d-xl-block">
               
               <button class="btn btn-primary" type="button" id="job-alert">@lang('modules.front.jobAlert')</button>
               </div>
