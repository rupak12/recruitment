...
@section('header-text')
    ...
    <div class="text-white">
        <a class="text-white" href="{{ route('jobs.jobOpenings') }}"><u>@lang('modules.front.jobOpenings')</u>&nbsp; </a> &raquo; &nbsp;<span
            class="text-white">{{ ucwords($job->title) }}</span>
    </div>
@endsection
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar bg-white" id="sidebar">
                        ...
                        <div class="p-30 bb-1">
                            ...
                            <p class="fw-400 text-color fs-16 mb-0">{{ $locations ? ucwords($locations->location) : null }}
                            </p>
                        </div>
                        ...
                        @if ($job->show_work_experience)
                            <div class="p-30 bb-1">
                                ...
                                <p class="fw-400 text-color fs-16 mb-0">
                                    {{ $job->workExperience ? $job->workExperience->work_experience : '--' }}</p>
                            </div>
                        @endif

                        <div class="p-30 bb-1 visible-print">

                            <p class="fw-500 fs-16 text-dark mb-0">@lang('modules.jobs.scantopay')</p>
                            {!! QrCode::size(200)->generate(route('jobs.jobApply', [$job->slug, $locations ? $locations->id : null])) !!}
                        </div>
                        ...
                        @if ($job->show_job_type)
                            <div class="p-30 bb-1">
                                ...
                                <p class="fw-400 text-color fs-16 mb-0">
                                    {{ $job->jobType ? $job->jobType->job_type : '--' }}</p>
                            </div>
                        @endif
                        ...
                        @if ($job->show_salary)
                            @if ($job->pay_type == 'Range')
                                <div class="p-30 bb-1">
                                    ...
                                    <p class="fw-400 text-color fs-16 mb-0">
                                        {{ $job->starting_salary . '--' . $job->maximum_salary . ' ' . '/' . $job->pay_according }}
                                    </p>
                                </div>
                            @elseif($job->pay_type == 'Starting')
                                <div class="p-30 bb-1">
                                    ...
                                    <p class="fw-400 text-color fs-16 mb-0">
                                        {{ $job->starting_salary . ' ' . '/' . $job->pay_according }} </p>
                                </div>
                        ...
                        <div class="p-30">
                            <a class="btn btn-block btn-primary theme-background"
                                href="{{ route('jobs.jobApply', [$job->slug, $locations ? $locations->id : null]) }}">@lang('modules.front.applyForJob')</a>
                        </div>
                        ...
                        <div class="py-10 border-light mt-20 text-center">
                            ...
                            <div class="social social-boxed social-colored social-cycling text-center my-10">
                                <a class="social-linkedin"
                                    href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('jobs.jobDetail', [$job->slug]) }}&title={{ urlencode(ucwords($job->title)) }}&source=LinkedIn"><i
                                        class="fa fa-linkedin"></i></a>
                                <a class="social-facebook"
                                    href="https://www.facebook.com/sharer/sharer.php?u={{ route('jobs.jobDetail', [$job->slug]) }}"><i
                                        class="fa fa-facebook"></i></a>
                                <a class="social-twitter"
                                    href="https://twitter.com/intent/tweet?status={{ route('jobs.jobDetail', [$job->slug]) }}"><i
                                        class="fa fa-twitter"></i></a>
                                <a class="social-gplus"
                                    href="https://plus.google.com/share?url={{ route('jobs.jobDetail', [$job->slug]) }}"><i
                                        class="fa fa-google-plus"></i></a>
                                <a class="social-gplus text-green" style="background-color:#7CD567"
                                    href="https://wa.me/?text={{ route('jobs.jobDetail', [$job->slug]) }}"><i
                                        class="fa fa-whatsapp "></i></a>
                            </div>
                        </div>
                        @if ($linkedinGlobal->status == 'enable')
                            <a class="my-10 applyWithLinkedin btn btn-block btn-primary "
                                href="{{ route('jobs.linkedinRedirect', 'linkedin') }}">
